...
test.describe('access control', () => {
  test('anonymous visiting /pedals/new → redirected to /auth/login', async ({
    page,
  }) => {
...
test.describe('create pedal', () => {
  ...
  test('missing brand → error message, re-renders add form on POST /pedals', async ({
    page,
  }) => {
    const addForm = new PedalFormPage(page, 'add');
    await addForm.goto();
  ...
  test('missing name → error message, re-renders add form on POST /pedals', async ({
    page,
  }) => {
    const addForm = new PedalFormPage(page, 'add');
    await addForm.goto();
...
test.describe('edit pedal', () => {
  ...
  test('list card edit icon → form pre-fills brand and name', async ({
    page,
  }) => {
