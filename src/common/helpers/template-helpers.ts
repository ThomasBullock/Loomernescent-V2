...
export const dump = (obj: unknown): string => JSON.stringify(obj, null, 2);
...
export const buildDatesString = (dates: DateInput[]): string => {
  return dates.reduce<string>((accum, next, index, arr) => {
