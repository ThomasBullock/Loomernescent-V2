...
export class AddBandImageKit1780828464348 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "pedals" ALTER COLUMN "used_by" SET DEFAULT '[]'`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "pedals" ALTER COLUMN "used_by" DROP DEFAULT`);
