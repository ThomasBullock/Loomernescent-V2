...
export class Init1776076196047 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pedals" ADD CONSTRAINT "FK_065aa747db521c33c9a68a67c6c" FOREIGN KEY ("associated_band_id") REFERENCES "bands"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "favourites" ADD CONSTRAINT "FK_8cf107d5585a5010599dba5d90d" FOREIGN KEY ("band_id") REFERENCES "bands"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "favourites" ADD CONSTRAINT "FK_93896b016bd1227d5053c68d8f3" FOREIGN KEY ("album_id") REFERENCES "albums"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "favourites" ADD CONSTRAINT "FK_89134f20ac10a30b870d21d6441" FOREIGN KEY ("pedal_id") REFERENCES "pedals"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "albums" ADD CONSTRAINT "FK_e7f0c9810c413c6bda257317b5e" FOREIGN KEY ("band_id") REFERENCES "bands"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bands" ADD CONSTRAINT "FK_2cbf614a12388fc86ed6b3623c2" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "bands" DROP CONSTRAINT "FK_2cbf614a12388fc86ed6b3623c2"`);
        await queryRunner.query(`ALTER TABLE "albums" DROP CONSTRAINT "FK_e7f0c9810c413c6bda257317b5e"`);
        await queryRunner.query(`ALTER TABLE "favourites" DROP CONSTRAINT "FK_89134f20ac10a30b870d21d6441"`);
        await queryRunner.query(`ALTER TABLE "favourites" DROP CONSTRAINT "FK_93896b016bd1227d5053c68d8f3"`);
        await queryRunner.query(`ALTER TABLE "favourites" DROP CONSTRAINT "FK_8cf107d5585a5010599dba5d90d"`);
        await queryRunner.query(`ALTER TABLE "favourites" DROP CONSTRAINT "FK_ffb0866c42b7ff4d6e5131f3dcc"`);
        await queryRunner.query(`ALTER TABLE "pedals" DROP CONSTRAINT "FK_065aa747db521c33c9a68a67c6c"`);
