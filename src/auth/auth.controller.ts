...
export class AuthController {
  ...
  @Post("/register")
  async register(@Body() body: RegisterBody, @Req() req: Request, @Res() res: Response) {
  ...
  @Post("/forgot")
  async forgot(@Body() body: ForgotBody, @Req() req: Request, @Res() res: Response) {
    if (body.commandant) {
      throw new BadRequestException();
    }
  ...
  @Get("/reset/:token")
  async getReset(@Param("token") token: string, @Req() req: Request, @Res() res: Response) {
